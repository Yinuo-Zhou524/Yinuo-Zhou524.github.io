...
<div class="photo-grid photo-grid-small">
  <figure class="photo-figure">
    ...
    <figcaption>In the lab w/ the boss</figcaption>
  </figure>

  <figure class="photo-figure">
    <a href="{{ '/assets/img/lab2.jpg' | relative_url }}" target="_blank">
      <img src="{{ '/assets/img/lab2.jpg' | relative_url }}" alt="Lab work and measurements" class="grid-photo">
    </a>
    <figcaption>Top Golfing</figcaption>
  </figure>
  ...
  <figure class="photo-figure">
    ...
    <figcaption>Enjoying life</figcaption>
  </figure>
</div>
...
<div class="photo-grid">
  <figure class="photo-figure">
    <a href="{{ '/assets/img/field1.jpg' | relative_url }}" target="_blank">
      <img src="{{ '/assets/img/field1.jpg' | relative_url }}" alt="Field research in forest site" class="grid-photo">
    </a>
    <figcaption>Field measurements</figcaption>
  </figure>
